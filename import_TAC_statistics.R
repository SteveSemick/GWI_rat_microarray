...
SST_RMA_Res = list.files('C:/Users/steph/Documents/R/UMB/PTSD_Rat_Project/TAC/SST-RMA_SingleRegions', pattern = '.txt', full.names = T)
...
res_FDR10 = lapply(res_stats, function(x) x[x[,'FDR P-val']<0.10,])

### Export results
# Write xlsx file
openxlsx::write.xlsx(res_stats, file='TAC/SST-RMA_SingleRegions/MergedStats.xlsx' )
openxlsx::write.xlsx(res_FDR05, file='TAC/SST-RMA_SingleRegions/MergedStats_FDR05.xlsx' )
openxlsx::write.xlsx(res_FDR10, file='TAC/SST-RMA_SingleRegions/MergedStats_FDR10.xlsx' )


# Write rda
save(res_stats, file='TAC/SST-RMA_SingleRegions/MergedStats.rda')
save(sst_rma_signal, file='TAC/SST-RMA_SingleRegions/Norm_signal.rda')
...
openxlsx::write.xlsx(res_FDR10, file='TAC/SST-RMA_BothRegions/MergedStats_FDR10.xlsx' )
