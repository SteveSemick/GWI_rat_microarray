...
Full_stats_LA_CTRLvPYR_LPS <- topTable(fitConEbInjury, num = Inf, coef="LA.Injury", adjust.method='none')
...
save(mergedStats, file='rda/FullModel_mergedStats_sst-RMA_R.rda')
write.csv(mergedStats, file='csvs/FullModel_mergedStats_sst-RMA_R.csv')